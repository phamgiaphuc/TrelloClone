  ...
  board: {
    ...
    columns: [
      ...
      },
      {
        ...
        cards: [
          { _id: 'column-id-04-placeholder-card', boardId: 'board-id-01', columnId: 'column-id-04', FE_PlaceholderCard: true } // FE_PlaceholderCard is FE's data only for the solution of empty column when draggin card
        ]
      }
    ]
  }
